...
* [Console] Added features to view task history and stop tasks
    * Added the feature to view the history of container emptying, object copy/move/delete tasks and to stop tasks.
* [API] Added the feature for container configuration using container policy documents
    * Added support for configuring access policy, CORS, and object lock container settings.
...
* [API] Added the write request rate limit policy
