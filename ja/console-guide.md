...
このドキュメントでは、NHN Cloudコンソールでオブジェクトストレージのコンテナとオブジェクトを管理する方法について説明します。
...
!!! tip "参考"
    ...
    設定できる条件ルールは最大30件です。この制限は[コンテナポリシー](container-policy-guide/#lifecycle)で設定する場合にも同様に適用されます。
