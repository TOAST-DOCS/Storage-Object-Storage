...
ライフサイクルの設定方法の詳細については、[ライフサイクルルールの適用方法](container-policy-guide/#lifecycle-apply)を参照してください。
...
ロールベースのアクセスポリシーに関係なく、設定した時間の間、指定したオブジェクトに自由にアクセスできる署名付き URL を生成します。詳細な使用方法については、[署名付き URL ガイド](presigned-url-guide/)を参照してください。
