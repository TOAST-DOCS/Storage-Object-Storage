...
### 기능 추가 { #september-1-2026-added-features }
...
### 기능 개선 { #september-1-2026-feature-updates }
...
### 기능 추가 { #june-2-2026-added-features }
* [콘솔] 수명 주기 규칙 설정 및 일괄 적용 기능 추가
* [API] 컨테이너 정책 문서를 통한 컨테이너 설정 기능 추가
    * 수명 주기 규칙 설정을 지원합니다.

<a id="june-2-2026-feature-updates"></a>
### 기능 개선 { #june-2-2026-feature-updates }
* [API] Amazon S3 API 호환성 개선
...
### 기능 추가 { #june-5-2025-added-features }
* [콘솔] 컨테이너 복제 일시 정지/재시작 기능 추가

<a id="june-5-2025-feature-updates"></a>
### 기능 개선 { #june-5-2025-feature-updates }
* [API] Amazon S3 API 호환성 개선
    * 오브젝트 목록에서 각 오브젝트의 LastModified 값이 밀리초 단위까지 표시되는 문제를 수정했습니다.

<a id="june-5-2025-bug-fixes"></a>
### 버그 수정 { #june-5-2025-bug-fixes }
...
### 기능 개선 { #september-5-2024-feature-updates }
...
### 기능 변경 { #september-5-2023-feature-updates }
...
<a id="june-8-2023-added-features"></a>
### 기능 추가 { #june-8-2023-added-features }
* [콘솔][API] IP ACL 기능 추가

<a id="april-4-2023"></a>
## 2023. 04. 04. { #april-4-2023 }
<a id="april-4-2023-feature-updates"></a>
### 기능 변경 { #april-4-2023-feature-updates }
* [API] API 엔드포인트 변경

<a id="april-4-2023-bug-fixes"></a>
### 버그 수정 { #april-4-2023-bug-fixes }
...
### 기능 추가 { #april-5-2022-added-features }
* [콘솔] S3 API 자격 증명 발급 기능 추가

<a id="april-5-2022-feature-updates"></a>
### 기능 개선 { #april-5-2022-feature-updates }
...
### 기능 개선 { #december-7-2021-feature-updates }
...
### 기능 개선 { #july-2-2021-feature-updates }
* [콘솔] 컨테이너 설정 기능 개선
...
### 기능 추가 { #november-3-2020-added-features }
