...
* [콘솔][API] 컨테이너 설정 항목 개수 제한 추가
    * 접근 정책(ACL)은 읽기, 쓰기, 조회 권한별로 최대 100개까지 설정할 수 있습니다.
    * IP 접근 제어(IP ACL)는 허용 IP 목록과 차단 IP 목록에 각각 최대 100개까지 설정할 수 있습니다.
    * CORS 허용 출처(Origin)와 노출할 응답 헤더는 각각 최대 100개까지 설정할 수 있습니다.
    * 수명 주기 조건 규칙은 최대 30개까지 설정할 수 있습니다.
...
### 신규 기능 추가 { #november-30-2023-added-features }
...
### 신규 기능 추가 { #june-8-2023-added-features }
* [콘솔][API] IP ACL 기능 추가

<a id="april-4-2023"></a>
## 2023. 04. 04. { #april-4-2023 }
<a id="april-4-2023-feature-updates"></a>
### 기능 개선/변경 { #april-4-2023-feature-updates }
* [API] API 엔드포인트 변경
