...
전통적인 파일 시스템은 데이터를 파일 단위로 계층형 디렉터리 구조에 저장하고 관리합니다. 디렉터리는 디스크라는 유한한 저장 공간 안에 존재합니다. 디스크의 용량이 가득 차면 데이터를 저장할 수 없습니다. 따라서 사용자는 데이터를 저장할 디스크의 용량을 고려해야 합니다. 그리고 파일을 어떤 디렉터리에 저장했는지 알고 있어야 사용할 수 있습니다.
