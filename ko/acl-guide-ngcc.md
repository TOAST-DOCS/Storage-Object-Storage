...
### 콘솔
콘솔에서는 [컨테이너 생성](console-guide-ngcc/#_2) 대화 상자 또는 [컨테이너 관리](console-guide-ngcc/#_5) 창의 컨테이너 접근 정책 설정 대화 상자에서 컨테이너 접근 정책을 선택할 수 있습니다. 선택할 수 있는 정책은 `PRIVATE`과 `PUBLIC` 두 가지로 제한됩니다.
