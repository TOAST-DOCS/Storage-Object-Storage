...
IP 기반의 접근 정책을 관리합니다. 접근 정책에 대한 자세한 내용은 [접근 정책 설정 가이드](acl-guide/)를 참조하세요.
...
<table class="it" style="padding-top: 15px; padding-bottom: 10px;">
  ...
  <tr>
    ...
    <td>IPv4</td>
    <td>화이트리스트에 등록할 IP를 입력합니다. IP(192.168.0.1) 또는 CIDR(192.168.0.0/24) 형식으로 입력 가능합니다.</td>
  </tr>
  <tr>
    <td>권한</td>
  ...
  <tr>
    ...
    <td>IPv4</td>
    <td>블랙리스트에 등록할 IP를 입력합니다. IP(192.168.0.1) 또는 CIDR(192.168.0.0/24) 형식으로 입력 가능합니다.</td>
  </tr>
  </tr>
  <tr>
    <td>권한</td>
