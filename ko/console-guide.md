...
컨테이너 복제를 시작합니다. 복제 시작 시 중지된 시점부터 복제가 재개됩니다.

##### 복제 중지

컨테이너 복제를 중지합니다. 복제 중지 상태에서는 원본 컨테이너 오브젝트를 삭제하거나 업데이트하더라도 복제가 실행되지 않습니다.

> [주의]
> 복제 중지 후 7일이 지난 뒤 재시작하는 경우, 중지 기간 중 삭제된 원본 컨테이너 오브젝트는 대상 컨테이너에 반영되지 않습니다.
