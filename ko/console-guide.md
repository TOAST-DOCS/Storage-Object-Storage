...
오브젝트 수명 주기 설정 후 컨테이너에 업로드한 오브젝트는 설정된 수명 주기가 지난 후 자동으로 삭제됩니다.

#### 오브젝트 버전 관리 설정

오브젝트 버전 관리 설정을 통해 오브젝트의 이전 버전을 보관할 수 있습니다. 이전 버전은 오브젝트를 업데이트할 때 지정한 아카이브 컨테이너에 보관되며, 설정을 통해 이전 버전에 대한 수명을 입력할 수 있습니다. 
