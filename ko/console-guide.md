...
### 서명된 URL 생성
선택한 오브젝트를 접근 정책에 관계 없이 설정한 시간 동안 자유롭게 접근할 수 있는 서명된 URL을 생성합니다.

> [참고]
> 단일 객체만 선택할 수 있으며, 폴더 객체는 선택할 수 없습니다.
> 유효 기간은 최대 720분까지 분 단위로 설정할 수 있습니다.

> [주의]
> 서명된 URL이 유출되면 누구나 선택한 오브젝트에 접근할 수 있습니다. 상황에 맞게 적절한 유효 기간을 설정하여 사용해야 합니다.
