...
> 멀티파트 오브젝트의 경우 해당 매니페스트 오브젝트만 삭제됩니다. 다른 컨테이너에 위치한 세그먼트 오브젝트는 삭제되지 않습니다.
...
> [참고]
> 멀티파트 오브젝트를 삭제하면 해당 매니페스트 오브젝트만 삭제됩니다. 세그먼트 오브젝트는 삭제되지 않습니다.
> 오브젝트 버전 관리 정책이 설정된 컨테이너에서 특정 버전을 지정하여 삭제하는 경우 해당 버전 오브젝트만 삭제됩니다.
