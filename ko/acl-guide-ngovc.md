...
### 콘솔
콘솔에서는 [컨테이너 생성](console-guide-ngovc/#_2) 대화 상자 또는 [컨테이너 관리](console-guide-ngovc/#_5) 창의 컨테이너 접근 정책 설정 대화 상자에서 컨테이너 접근 정책을 선택할 수 있습니다. 선택할 수 있는 정책은 `PRIVATE`과 `PUBLIC` 두 가지로 제한됩니다.
...
```
$ curl -O -X GET \
  https://kr4-api-object-storage.ngovc.go.kr/v1/AUTH_*****/container/object
