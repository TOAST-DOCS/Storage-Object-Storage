...
**[Method, URL]**
```
GET   https://api-identity-infrastructure.ngsc-nhncloudservice.go.kr/v2.0/users/{user-id}/credentials/OS-EC2
...
**[Method, URL]**
```
DELETE   https://api-identity-infrastructure.ngsc-nhncloudservice.go.kr/v2.0/users/{user-id}/credentials/OS-EC2/{access}
