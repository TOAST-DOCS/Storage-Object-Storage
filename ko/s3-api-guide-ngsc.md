...
| 이름 | 설명 |
|---|---|
| endpoint | https://https://kr4-api-object-storage.ngsc.go.kr |
...
```shell
$ aws --endpoint-url=https://https://kr4-api-object-storage.ngsc.go.kr s3 mb s3://example-bucket
...
```shell
$ aws --endpoint-url=https://https://kr4-api-object-storage.ngsc.go.kr s3 ls
...
```shell
$ aws --endpoint-url=https://https://kr4-api-object-storage.ngsc.go.kr s3 ls s3://example-bucket
...
```shell
$ aws --endpoint-url=https://https://kr4-api-object-storage.ngsc.go.kr s3 rb s3://example-bucket
...
```shell
$ aws --endpoint-url=https://https://kr4-api-object-storage.ngsc.go.kr s3 cp ./3b5ab489edffdea7bf4d914e3e9b8240.jpg s3://example-bucket/3b5ab489edffdea7bf4d914e3e9b8240.jpg
...
```shell
$ aws --endpoint-url=https://https://kr4-api-object-storage.ngsc.go.kr s3 cp s3://example-bucket/3b5ab489edffdea7bf4d914e3e9b8240.jpg ./3b5ab489edffdea7bf4d914e3e9b8240.jpg
...
```shell
$ aws --endpoint-url=https://https://kr4-api-object-storage.ngsc.go.kr s3 rm s3://example-bucket/3b5ab489edffdea7bf4d914e3e9b8240.jpg
