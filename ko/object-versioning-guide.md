...
기존 버전 관리 정책의 단점을 보완하여 버전 오브젝트를 손쉽게 조회하고 관리할 수 있습니다.
...
콘솔의 **객체 복구** 또는 **버전 오브젝트 복사**, **버전 오브젝트 삭제**를 통해 버전 오브젝트를 복구할 수 있습니다.
...
버전 오브젝트를 삭제할 수 있습니다. 현재 버전 오브젝트를 지정하여 삭제하면 직전 버전으로 복구되거나, 삭제됩니다.

* 현재 버전이 삭제 마커 오브젝트라면, 직전 버전으로 복구됩니다.
* 직전 버전이 버전 오브젝트라면, 직전 버전으로 복구됩니다.
* 직전 버전이 삭제 마커 오브젝트라면, 삭제 됩니다.

현재 버전 오브젝트를 지정하여 삭제했을 때, 직전 버전 오브젝트가 삭제 마커 오브젝트이면 오브젝트가 삭제되며, 버전 ID를 지정하지 않으면 조회할 수 있습니다.
